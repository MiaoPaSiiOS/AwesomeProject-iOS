...
@implementation AMENWebKitGlobal

+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static AMENWebKitGlobal *instance = nil;
...
+ (BOOL)SpecialIOSListFlag:(NSString *)netUrl {
    ...
    [netPageUrl addObjectsFromArray:[[AMENWebKitGlobal sharedInstance] pageSpecialList]];
...
+ (BOOL)DomainFlag:(NSString *)netUrl {
    //菜单列表［domain];
    NSMutableArray *netPageUrl = [[NSMutableArray alloc] init];
    [netPageUrl addObjectsFromArray:[[AMENWebKitGlobal sharedInstance] pageWhiteList]];
    //固化 bankcomm.com
