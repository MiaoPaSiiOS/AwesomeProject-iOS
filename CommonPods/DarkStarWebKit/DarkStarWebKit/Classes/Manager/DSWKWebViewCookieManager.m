...
@implementation DSWKWebViewCookieManager
+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static DSWKWebViewCookieManager *instance = nil;
...
+ (NSString *)ajaxCookieScripts {
    @autoreleasepool {
        NSArray *cookieArr = [[DSWKWebViewCookieManager sharedInstance] sharedHTTPCookieStorage];
