...
@implementation AMENWebViewCacheManager
...
+ (NSMutableURLRequest *)achiveRequestWithURL:(NSURL *)url timeoutInterval:(NSTimeInterval)timeInterval {
    ...
    if ([str isEqualToString:@"1"] &&
        [AMENWebKitGlobal sharedInstance].webCacheWhiteList &&
        [[AMENWebKitGlobal sharedInstance].webCacheWhiteList isKindOfClass:[NSArray class]]) { // 总开关打开
        for (NSDictionary *aDict in [AMENWebKitGlobal sharedInstance].webCacheWhiteList) {
