...
@interface AreaJsbWKWebViewController : AresJsbWKWebViewController

@property(nonatomic, strong) AreaJsbRequestModel *reqModel;
///// 重新加载 url
...
//#pragma mark - 加载方式
//@property(nonatomic, assign) AresJsbWKWebViewLoad loadType;
