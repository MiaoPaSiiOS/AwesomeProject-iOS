...
#import "Masonry.h"
@interface AmenJsbWKWebViewController ()<WKNavigationDelegate,UIScrollViewDelegate>
@property(nonatomic, strong, readwrite) AmenJsbWKWebView *baseWebView;
...
@implementation AmenJsbWKWebViewController
...
#pragma mark - WKWebView
    ...
    self.baseWebView = [[AmenJsbWKWebView alloc] initWithFrame:self.dsView.bounds configuration:self.configuration];
