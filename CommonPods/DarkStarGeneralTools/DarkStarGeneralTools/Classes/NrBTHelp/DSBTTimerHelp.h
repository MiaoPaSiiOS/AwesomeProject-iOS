...
@protocol DSBTTimerHelpDelegate <NSObject>

@optional

-(void)BTTimeChanged:(DSBTTimerHelp*)timer;

@end

typedef void(^BTTimerChangeBlock)(void);

@interface DSBTTimerHelp : NSObject
...
@property(nonatomic,weak,nullable)id<DSBTTimerHelpDelegate> delegate;
