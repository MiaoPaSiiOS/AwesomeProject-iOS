...
@interface DSIrregularElementsCreator ()
...
@implementation DSIrregularElementsCreator
...
+ (instancetype)irregularElementsCreatorWithItemIsRightToLeft:(BOOL)isRightToLeft
    ...
    DSIrregularElementsCreator *creator = [DSIrregularElementsCreator new];
...
+ (void)irregularElementsCreatorWithItemIsRightToLeft:(BOOL)isRightToLeft
    ...
    DSIrregularElementsCreator *creator = [DSIrregularElementsCreator irregularElementsCreatorWithItemIsRightToLeft:isRightToLeft
