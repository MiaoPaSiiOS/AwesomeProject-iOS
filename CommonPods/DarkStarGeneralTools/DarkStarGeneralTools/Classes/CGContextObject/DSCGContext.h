...
typedef void(^DSCGContextDrawBlock_t)(DSCGContext *contextObject);

@interface DSCGContext : NSObject
 ...
 */
@property (nonatomic, strong, readonly) DSCGContextConfig *currentConfig;

/**
 *  Context config array.
 */
@property (nonatomic, strong, readonly) NSMutableDictionary <NSString *, DSCGContextConfig *> *configs;
 ...
 */
- (void)useCGContextConfig:(DSCGContextConfig *)contextConfig
 ...
 */
- (void)contextConfig:(DSCGContextConfig *)config drawStrokeBlock:(DSCGContextDrawBlock_t)block;
 ...
 *  @param block  draw block
 */
- (void)contextConfig:(DSCGContextConfig *)config drawFillBlock:(DSCGContextDrawBlock_t)block;
 ...
 *  @param block       draw block
 */
- (void)contextConfig:(DSCGContextConfig *)config drawingMode:(CGPathDrawingMode)drawingMode drawBlock:(DSCGContextDrawBlock_t)block;
