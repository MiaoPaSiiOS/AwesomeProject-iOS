...
#import "DSCollectionCustomTagLayout.h"

@interface DSCollectionCustomTagLayout()
// 可见区域
...
@implementation DSCollectionCustomTagLayout
#pragma mark - 初始化属性
- (instancetype)init {
    self = [super init];
    if (self) {
...
- (void)prepareLayout {
    ...
    for (NSInteger section = 0; section < sections; section++) {
        ...
        //head
        CGSize sectionHeadSize = [self.delegate DSCollectionCustomTagLayout:self sizeForSupplementaryElementOfKind:UICollectionElementKindSectionHeader section:section];
        ...
        for (NSInteger item = 0; item < rows; item++) {
            ...
            CGFloat tagWidth = [self.delegate DSCollectionCustomTagLayout:self tagWidthForItemAt:indexPath];
        ...
        //footer
        CGSize sectionFooterSize = [self.delegate DSCollectionCustomTagLayout:self sizeForSupplementaryElementOfKind:UICollectionElementKindSectionFooter section:section];
