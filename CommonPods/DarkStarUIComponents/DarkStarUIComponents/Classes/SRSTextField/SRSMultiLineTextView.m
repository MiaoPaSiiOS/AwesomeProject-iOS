...
- (void)changeToErrorStatus {
    self.textView.textColor = [DSHelper colorWithHexString:@"0xFF4D29"];
    self.clearBtn.alpha = 0;
}
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, DSDeviceInfo.screenWidth, (82));
...
- (void)textViewDidChange:(UITextView *)textView {
    ...
    self.textView.textColor = [DSHelper colorWithHexString:@"0x222222"];
...
- (UITextView *)textView {
    if (!_textView) {
        ...
        _textView.textColor = [DSHelper colorWithHexString:@"0x222222"];
...
- (UILabel *)placeholderLabel {
    if (!_placeholderLabel) {
        ...
        _placeholderLabel.textColor = [DSHelper colorWithHexString:@"0xCCCCCC"];
