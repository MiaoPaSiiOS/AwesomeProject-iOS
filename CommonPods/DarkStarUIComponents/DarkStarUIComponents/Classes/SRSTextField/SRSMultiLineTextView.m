...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, kScreenWidth, (82));
...
- (UIButton *)clearBtn {
    if (!_clearBtn) {
        ...
        [_clearBtn setBackgroundImage:[NSObject ds_imageNamed:@"clear" inBundle:[NSObject ds_bundleName:@"NrSRSTextFieldAssets" inPod:@"NrUIComponents"]] forState:UIControlStateNormal];
