...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [DSHelper colorWithHexString:@"0x444444"];
...
- (UILabel *)lineLabel {
    if (!_lineLabel) {
        ...
        _lineLabel.backgroundColor = [DSHelper colorWithHexString:@"0xE8E8E8"];
    }
    return _lineLabel;
}
...
- (UILabel *)bottomLabel {
    if (!_bottomLabel) {
        ...
        _bottomLabel.textColor = [DSHelper colorWithHexString:@"0x888888"];
...
- (UIButton *)clearBtnImage {
    if (!_clearBtnImage) {
        ...
        [_clearBtnImage setBackgroundImage:[DSHelper imageNamed:@"clear" inBundle:[DSHelper findBundleWithBundleName:@"NrSRSTextFieldAssets" podName:@"NrUIComponents"]] forState:UIControlStateNormal];
