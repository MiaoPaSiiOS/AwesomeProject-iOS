...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.cursor.backgroundColor = [DSHelper colorWithHexString:@"0x4586FF"];
        ...
        self.bottomLabel.backgroundColor = [DSHelper colorWithHexString:@"0x444444"];
...
- (void)setStatus:(eSRSBottomLabelStatus)status {
    ...
    switch (status) {
            ...
            self.bottomLabel.backgroundColor = [DSHelper colorWithHexString:@"0xFF4D29"];
            break;
            case eSRSBottomLabelStatusInput:
            self.bottomLabel.backgroundColor = [DSHelper colorWithHexString:@"0x4586FF"];
            break;
