...
/*
 ...
 - (void)showPrivacyAgreementAlert {
     ...
     [SRSAttributedClickLabelAlert alertWithConfigLable:^(TTTAttributedLabel * _Nonnull lable) {
         //赋值
         NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc]initWithString:full attributes: @{NSForegroundColorAttributeName: [DSHelper colorWithHexString:@"0x333333"],NSFontAttributeName: FONT_REGULAR(16)}];
