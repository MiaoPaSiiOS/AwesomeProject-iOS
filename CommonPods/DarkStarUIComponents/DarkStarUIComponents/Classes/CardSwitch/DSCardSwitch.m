...
@interface DSCardSwitch ()<UICollectionViewDelegate,UICollectionViewDataSource,DSCardSwitchFlowLayoutDataSource>

@property (nonatomic, strong) UICollectionView *collectionView;

@property (nonatomic, strong) DSCardSwitchFlowLayout *flowLayout;

@end

@implementation DSCardSwitch
...
- (void)setupMainView
{
    self.flowLayout = [[DSCardSwitchFlowLayout alloc] init];
...
#pragma mark -
#pragma mark -DSCardSwitchFlowLayout
