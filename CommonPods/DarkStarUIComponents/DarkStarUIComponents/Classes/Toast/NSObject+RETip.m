...
{
    [self re_show:message icon:[DSResourceTool imageNamed:@"progresshud-error"] view:view];
}
...
{
    [self re_show:message icon:[DSResourceTool imageNamed:@"progresshud-success"] view:view];
}
