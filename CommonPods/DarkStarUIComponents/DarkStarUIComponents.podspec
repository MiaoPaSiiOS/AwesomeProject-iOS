...
#  end
  # s.frameworks = 'UIKit', 'MapKit'
  # s.dependency 'AFNetworking', '~> 2.3'
  s.subspec 'Waitview' do |ss|
    ss.source_files = 'DarkStarUIComponents/Classes/Waitview'
  ...
  s.subspec 'CornerView' do |ss|
    ss.source_files = 'DarkStarUIComponents/Classes/CornerView'
    ss.dependency 'Masonry'
    ss.dependency 'DarkStarBaseKit'
  end
  ...
  s.subspec 'Button' do |ss|
    ss.source_files = 'DarkStarUIComponents/Classes/Button'
    ss.dependency 'DarkStarBaseKit'
  end
