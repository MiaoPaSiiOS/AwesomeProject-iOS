...
- (instancetype)initWithFrame:(CGRect)frame withType:(DSScannerType)type {
    ...
    CGRect a = CGRectMake((DSDeviceInfo.screenWidth - scanSize.width)/2,(DSDeviceInfo.screenHeight - scanSize.width)/2, scanSize.width, scanSize.height);
...
- (void)addScanBox{
    ...
    _infolabel = [[UILabel alloc]initWithFrame:CGRectMake((DSDeviceInfo.screenWidth-250)/2,self.middleIcon.bottom+20,250,21)];
