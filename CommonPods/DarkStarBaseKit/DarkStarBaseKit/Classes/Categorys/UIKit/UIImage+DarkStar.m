...
{
    return [self ds_imageByRoundCornerRadius:radius
...
- (nullable UIImage *)ds_circleImageByBorderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor
{
    if (self.size.width == self.size.height) {
        return [self ds_imageByRoundCornerRadius:self.size.width/2 borderWidth:borderWidth borderColor:borderColor];
    } else {
        ...
        UIImage *newImage = [self ds_imageClipRect:CGRectMake(pointX, pointY, min, min)];
        return [newImage ds_imageByRoundCornerRadius:min/2 borderWidth:borderWidth borderColor:borderColor];
    }
}
...
{
    return [UIImage ds_cornerRadiusImageWithColor:color targetSize:targetSize corners:UIRectCornerAllCorners cornerRadius:0 backgroundColor:[UIColor whiteColor]];
}

+ (UIImage *)ds_cornerRadiusImageWithColor:(UIColor *)color targetSize:(CGSize)targetSize cornerRadius:(CGFloat)cornerRadius
{
    return [UIImage ds_cornerRadiusImageWithColor:color targetSize:targetSize corners:UIRectCornerAllCorners cornerRadius:cornerRadius backgroundColor:[UIColor whiteColor]];
}
...
-(UIImage *)ds_applyLightEffect
{
    ...
    return [self ds_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
-(UIImage *)ds_applyExtraLightEffect
{
    UIColor *tintColor =[UIColor colorWithWhite:0.97 alpha:0.82];
    return [self ds_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
-(UIImage *)ds_applyTintEffectWithColor:(UIColor*)tintColor
{
    ...
    return [self ds_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
...
#pragma mark - 其他
+ (UIImage *)ds_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock
{
