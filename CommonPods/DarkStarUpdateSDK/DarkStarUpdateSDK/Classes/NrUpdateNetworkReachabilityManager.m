//
//  NrUpdateNetworkReachabilityManager.m
//  IU_UpdateSDK
//
//
...
@interface NrUpdateNetworkReachabilityManager ()
...
@implementation NrUpdateNetworkReachabilityManager

+ (instancetype)sharedManager {
    static NrUpdateNetworkReachabilityManager *_sharedManager = nil;
...
+ (instancetype)managerForAddress:(const void *)address {
    ...
    NrUpdateNetworkReachabilityManager *manager = [[self alloc] initWithReachability:reachability];
