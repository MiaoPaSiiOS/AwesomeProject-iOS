...
{
    // Background
    self.view.backgroundColor = [DSHelper colorWithHexString:@"0xF7F8F8"];
    
    // topBar
    UIView *topBar = [[UIView alloc] initWithFrame:CGRectZero];
    topBar.frame = CGRectMake(0, SafeAreaInsetsConstantForDeviceWithNotch.top, DSDeviceInfo.screenWidth, DSDeviceInfo.naviBarContentHeight);
    topBar.backgroundColor = [DSHelper colorWithHexString:@"0xebedee"];
    ...
    tableView.separatorColor = [DSHelper colorWithHexString:@"0xebedee"];
...
{
    ((UITableViewHeaderFooterView *)view).textLabel.textColor = [DSHelper colorWithHexString:@"0xbac1c5"];
}
