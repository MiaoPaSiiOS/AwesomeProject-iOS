...
- (void)setupUI
{
    ...
    [_cancelButton setTitleColor:[DSHelper colorWithHexString:@"0x63dab9"] forState:UIControlStateNormal];
    ...
    [_scaleButton setTitleColor:[DSHelper colorWithHexString:@"0x63dab9"] forState:UIControlStateNormal];
    ...
    [_rotateButton setTitleColor:[DSHelper colorWithHexString:@"0x63dab9"] forState:UIControlStateNormal];
    ...
    [_finishButton setTitleColor:[DSHelper colorWithHexString:@"0x63dab9"] forState:UIControlStateNormal];
    ...
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        if (maskRect.origin.x <= imageRect.origin.x && maskRect.origin.y <= imageRect.origin.y) {
            [UIView animateWithDuration:0.4 animations:^{
                CGRect rect = self->_imageView.frame;
                rect.origin = maskRect.origin;
                self->_imageView.frame = rect;
            } completion:^(BOOL finished) {
                self->_currentPoint = self->_imageView.frame.origin;
            }];
            ...
            CGFloat x = maskRect.origin.x + maskRect.size.width - self->_imageView.bounds.size.width;
            CGFloat y = maskRect.origin.y + maskRect.size.height - self->_imageView.bounds.size.height;
            [UIView animateWithDuration:0.4 animations:^{
                CGRect rect = self->_imageView.frame;
                rect.origin.x = x;
                rect.origin.y = y;
