...
- (void)setupUI
{
    ...
    topBg.frame = CGRectMake(0, SafeAreaInsetsConstantForDeviceWithNotch.top, kScreenWidth, kNaviBarContentHeight);
    ...
    [self.cameraFilterView setFilterWillShowBlock:^{
        ...
        [UIView animateWithDuration:0.3f animations:^{
            ...
            self.takePhotoBtn.frame = CGRectMake(kScreenWidth/2 - self->_cameraTakePhotoIconSize/4, kScreenHeight - self->_cameraViewBottomBGHeight/2 - self->_cameraTakePhotoIconSize/4, self->_cameraTakePhotoIconSize/2, self->_cameraTakePhotoIconSize/2);
        } completion:^(BOOL finished) {
            // 再移动
            [UIView animateWithDuration:0.1f animations:^{
                self.takePhotoBtn.frame = CGRectMake(kScreenWidth/2 - self->_cameraTakePhotoIconSize/4, kScreenHeight - (self->_cameraViewBottomBGHeight - 84)/2 - self->_cameraTakePhotoIconSize/4, self->_cameraTakePhotoIconSize/2, self->_cameraTakePhotoIconSize/2);
            } completion:^(BOOL finished) {
                // 最后交换层顺序
    ...
    [self.cameraFilterView setFilterWillHideBlock:^{
        ...
        [UIView animateWithDuration:0.2f animations:^{
            ...
            [UIView animateWithDuration:0.3f animations:^{
                ...
                self.takePhotoBtn.frame = CGRectMake(kScreenWidth/2 - self->_cameraTakePhotoIconSize/2, kScreenHeight - self->_cameraViewBottomBGHeight/2 - self->_cameraTakePhotoIconSize/2, self->_cameraTakePhotoIconSize, self->_cameraTakePhotoIconSize);
            }];
        }];
    }];
}
