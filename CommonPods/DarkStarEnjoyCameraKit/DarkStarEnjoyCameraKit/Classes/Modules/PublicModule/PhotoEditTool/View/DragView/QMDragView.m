...
- (void)setupUIWithSize:(CGSize)size
{
    ...
    [_closeBtn setImage:[AECResouce imageNamed:@"qmkit_drag_close"] forState:UIControlStateNormal];
    ...
    [_flipBtn setImage:[AECResouce imageNamed:@"qmkit_drag_flip"] forState:UIControlStateNormal];
    ...
    [_rotationBtn setImage:[AECResouce imageNamed:@"qmkit_drag_rotate"] forState:UIControlStateNormal];
    ...
    [_scaleBtn setImage:[AECResouce imageNamed:@"qmkit_drag_scale"] forState:UIControlStateNormal];
