...
- (void)buildCollectionView
{
    ...
    [collectionView registerNib:[AECResouce nibWithNibName:@"QMCropThemeViewCell"] forCellWithReuseIdentifier:kCropThemeCollectionViewCellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.image = [AECResouce imageNamed:model.icon];
    return cell;
}
