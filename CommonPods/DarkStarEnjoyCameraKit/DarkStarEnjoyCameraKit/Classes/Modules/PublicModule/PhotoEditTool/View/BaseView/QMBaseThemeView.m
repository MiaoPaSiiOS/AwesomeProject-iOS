...
#define kFilterThemeViewDefaultHeight    240
...
- (void)buildToolBar
{
    ...
    [closeBtn setImage:[AECResouce imageNamed:@"qmkit_bar_close_btn"] forState:UIControlStateNormal];
    ...
    [okBtn setImage:[AECResouce imageNamed:@"qmkit_bar_ok_btn"] forState:UIControlStateNormal];
...
- (void)show
{
    ...
    [UIView animateWithDuration:0.4 animations:^{
        float height = [UIScreen mainScreen].bounds.size.height;
        float width = [UIScreen mainScreen].bounds.size.width;
        self.frame = CGRectMake(0, height-kFilterThemeViewDefaultHeight - SafeAreaInsetsConstantForDeviceWithNotch.bottom, width, kFilterThemeViewDefaultHeight + SafeAreaInsetsConstantForDeviceWithNotch.bottom);
    } completion:NULL];
}
