...
- (instancetype)init {
    self = [super init];
    self.width = DSDeviceInfo.screenWidth;
    ...
    _avatarView.layer.borderWidth = DSDeviceInfo.LINE_HEIGHT;
    ...
    _conversationTopJoin.backgroundColor = [DSHelper colorWithHexString:@"0xe1e8ed"];
    ...
    _topLine = [UIView new];
    _topLine.width = DSDeviceInfo.screenWidth;
    _topLine.height = DSDeviceInfo.LINE_HEIGHT;
