...
- (void)layout {
    ...
    if (tweet.card) {
        ...
        NSAttributedString *icon = [NSAttributedString yy_attachmentStringWithContent:iconImage contentMode:UIViewContentModeCenter attachmentSize:iconImage.size alignToFont:nameSubFont alignment:YYTextVerticalAlignmentCenter];
        [dateText yy_insertString:@" " atIndex:0];
        [dateText insertAttributedString:icon atIndex:0];
    }
    dateText.yy_font = nameSubFont;
    dateText.yy_color = kT1UserNameSubColor;
    dateText.yy_alignment = NSTextAlignmentRight;
    ...
    nameText.yy_color = kT1UserNameColor;
    if (tweet.user.screenName) {
        ...
        [screenNameText yy_insertString:@" @" atIndex:0];
        screenNameText.yy_font = nameSubFont;
        screenNameText.yy_color = kT1UserNameSubColor;
    ...
    if (socialString) {
        ...
        socialText.yy_font = nameSubFont;
        socialText.yy_color = kT1UserNameSubColor;
        socialText.yy_lineBreakMode = NSLineBreakByCharWrapping;
...
- (NSAttributedString *)textForTweet:(T1Tweet *)tweet{
    ...
    text.yy_font = [UIFont systemFontOfSize:kT1TextFontSize];
    text.yy_color = kT1TextColor;
...
- (void)setHighlightInfo:(NSDictionary*)info withRange:(NSRange)range toText:(NSMutableAttributedString *)text {
    ...
    [text yy_setColor:kT1TextHighlightedColor range:range];
}
...
- (YYTextLayout *)retweetCountTextLayoutForTweet:(T1Tweet *)tweet {
    if (tweet.retweetCount > 0) {
        ...
        retweet.yy_font = [UIFont systemFontOfSize:kT1ActionFontSize];
        retweet.yy_color = tweet.retweeted ? kT1TextActionRetweetColor : kT1TextActionsColor;
...
- (YYTextLayout *)favoriteCountTextLayoutForTweet:(T1Tweet *)tweet {
    if (tweet.favoriteCount > 0) {
        ...
        favourite.yy_font = [UIFont systemFontOfSize:kT1ActionFontSize];
        favourite.yy_color = tweet.favorited ? kT1TextActionFavoriteColor : kT1TextActionsColor;
