...
- (void)_initTextView {
    ...
    if (placeholderPlainText) {
        ...
        atr.yy_color = [DSHelper colorWithHexString:@"0xb4b4b4"];
...
- (void)_initToolbar {
    ...
    _toolbarBackground.backgroundColor = [DSHelper colorWithHexString:@"0xF9F9F9"];
    ...
    _toolbarPOIButton.layer.borderColor = [DSHelper colorWithHexString:@"0xe4e4e4"].CGColor;
    _toolbarPOIButton.layer.borderWidth = DSDeviceInfo.LINE_HEIGHT;
    ...
    _toolbarGroupButton.layer.borderColor = [DSHelper colorWithHexString:@"0xe4e4e4"].CGColor;
    _toolbarGroupButton.layer.borderWidth = DSDeviceInfo.LINE_HEIGHT;
    ...
    _toolbar.bottom = DSDeviceInfo.screenHeight - self.appBar.height - SafeAreaInsetsConstantForDeviceWithNotch.bottom;
...
- (UIButton *)navbarCancleButton {
    if (!_navbarCancleButton) {
        ...
        _navbarCancleButton.right = DSDeviceInfo.screenWidth - 12;
        ...
        [_navbarCancleButton setTitleColor:[DSHelper colorWithHexString:@"0x939393"]forState:UIControlStateNormal];
...
- (UIButton *)navbarPublishButton {
    if (!_navbarPublishButton) {
        ...
        _navbarPublishButton.layer.borderColor = [DSHelper colorWithHexString:@"0xe4e4e4"].CGColor;
        _navbarPublishButton.layer.borderWidth = DSDeviceInfo.LINE_HEIGHT;
