...
// 颜色
#define kWBCellNameNormalColor kHexColor(0x333333) // 名字颜色
#define kWBCellNameOrangeColor kHexColor(0xf26220) // 橙名颜色 (VIP)
#define kWBCellTimeNormalColor kHexColor(0x828282) // 时间颜色
#define kWBCellTimeOrangeColor kHexColor(0xf28824) // 橙色时间 (最新刷出)

#define kWBCellTextNormalColor kHexColor(0x333333) // 一般文本色
#define kWBCellTextSubTitleColor kHexColor(0x5d5d5d) // 次要文本色
#define kWBCellTextHighlightColor kHexColor(0x527ead) // Link 文本色
#define kWBCellTextHighlightBackgroundColor kHexColor(0xbfdffe) // Link 点击背景色
#define kWBCellToolbarTitleColor kHexColor(0x929292) // 工具栏文本色
#define kWBCellToolbarTitleHighlightColor kHexColor(0xdf422d) // 工具栏文本高亮色

#define kWBCellBackgroundColor kHexColor(0xf2f2f2)    // Cell背景灰色
#define kWBCellHighlightColor kHexColor(0xf0f0f0)     // Cell高亮时灰色
#define kWBCellInnerViewColor kHexColor(0xf7f7f7)   // Cell内部卡片灰色
#define kWBCellInnerViewHighlightColor  kHexColor(0xf0f0f0) // Cell内部卡片高亮时灰色
