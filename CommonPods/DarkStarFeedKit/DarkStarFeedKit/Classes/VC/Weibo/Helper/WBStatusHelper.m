...
+ (NSBundle *)bundle {
    ...
    dispatch_once(&onceToken, ^{
        NSString *path = [[AmenFeedTool AssetsWeiboBundle] pathForResource:@"ResourceWeibo" ofType:@"bundle"];
...
+ (NSBundle *)emoticonBundle {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        NSString *bundlePath = [[AmenFeedTool AssetsWeiboBundle] pathForResource:@"EmoticonWeibo" ofType:@"bundle"];
...
+ (NSDictionary *)emoticonDic {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        NSString *emoticonBundlePath = [[AmenFeedTool AssetsWeiboBundle] pathForResource:@"EmoticonWeibo" ofType:@"bundle"];
