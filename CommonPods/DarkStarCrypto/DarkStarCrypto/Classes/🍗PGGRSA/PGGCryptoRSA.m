 ...
 * -------RSA 公钥文件加密-------
 ...
 @return 密文，加密后的字符串
 */
+ (NSString *)encryptString:(NSString *)plaintext publicKeyWithContentsOfFile:(NSString *)path{
    if (!plaintext || !path)  return nil;
 ...
 * -------RSA 私钥文件解密-------
 ...
 @return 明文，解密后的字符串
 */
+ (NSString *)decryptString:(NSString *)ciphertext privateKeyWithContentsOfFile:(NSString *)path password:(NSString *)pwd{
    if (!ciphertext || !path) return nil;
    if (!pwd) pwd = @"";
 ...
 * -------RSA 字符串公钥加密-------
 ...
 @return 密文，加密后的字符串
 */
+ (NSString *)encryptString:(NSString *)plaintext publicKey:(NSString *)pubKey{
...
+ (SecKeyRef)addPublicKey:(NSString *)key{
    ...
    NSString *tag = @"nr_crypto_public_key";
 ...
 * -------RSA 字符串私钥解密-------
 ...
 @return 明文，解密后的字符串
 */
+ (NSString *)decryptString:(NSString *)ciphertext privateKey:(NSString *)privKey{
...
+ (SecKeyRef)addPrivateKey:(NSString *)key{
    ...
    if(!data){
        ...
        //a tag to read/write keychain storage
    NSString *tag = @"nr_crypto_private_key";
    NSData *d_tag = [NSData dataWithBytes:[tag UTF8String] length:[tag length]];
