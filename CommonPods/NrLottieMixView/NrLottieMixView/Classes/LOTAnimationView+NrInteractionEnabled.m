//
//  LOTAnimationView+NrInteractionEnabled.m
//  lottie-ios
//
//  Created by zhuyuhui on 2023/1/9.
//

#import "LOTAnimationView+NrInteractionEnabled.h"
#import "LOTAnimationView+NrMixView.h"
@interface LOTAnimationView (forward)
@property (nonatomic, strong) NSArray<CALayer *> *mixLayers;
@end

@implementation LOTAnimationView (NrInteractionEnabled)
