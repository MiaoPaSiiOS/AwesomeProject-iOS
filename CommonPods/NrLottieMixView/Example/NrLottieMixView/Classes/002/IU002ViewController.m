...
#import "IU002ViewController.h"
#import <Lottie/Lottie.h>
@interface IU002ViewController ()
@property (nonatomic, strong) LOTAnimationView *loader;
@end

@implementation IU002ViewController
...
- (LOTAnimationView *)loader {
    if (_loader == nil) {
        _loader = [LOTAnimationView animationNamed:@"Boat_Loader" inBundle:[NSBundle mainBundle]];
