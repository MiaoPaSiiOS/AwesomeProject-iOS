...
#import <DarkStarPhotoBrowserKit/DarkStarPhotoBrowserKit.h>
...
- (NSString *)imagePathWithNamed:(NSString *)name {
    return [DSHelper safeString:([DSAwesomeKitTool imagePathWithNamed:name inDirectory:@"[展示]图片浏览器"])];
}
...
- (void)viewDidLoad {
    ...
    if (self.isImgae) {
        ...
        for (NSInteger i = 0; i < 13; i++) {
            [self.imageDataArray addObject:[self imageNamed:@"placeholder"]];
        }
...
//                               [UIImage sd_imageWithGIFData:[NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"localGifImage0" ofType:@"gif"]]],
                               [self imageNamed:@"localImage0.jpeg"],
                               [self imageNamed:@"localImage1.jpeg"],
                               [self imageNamed:@"localImage2.jpeg"],
                               [self imageNamed:@"localImage3.jpeg"],
                               [self imageNamed:@"localLongImage1.jpg"],
//                               [UIImage sd_imageWithGIFData:[NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"localGifImage1" ofType:@"gif"]]],
                               [self imageNamed:@"localImage4.jpeg"],
                               [SDAnimatedImage imageWithContentsOfFile:[self imagePathWithNamed:@"localGifImage1.gif"]],
                               [self imageNamed:@"localImage5.jpeg"],
                               [self imageNamed:@"localLongImage0.jpg"],
                               [self imageNamed:@"localBigImage0.jpeg"],
                               [SDAnimatedImage imageWithContentsOfFile:[self imagePathWithNamed:@"localGifImage0.gif"]],
                               [self imageNamed:@"localImage6.jpeg"],
                               [self imageNamed:@"localImage7.jpeg"],
                               [self imageNamed:@"localImage8.jpeg"],
                               [self imageNamed:@"localImage9.jpeg"],
                               ];
            //主线程
        ...
        self.urlDataArray = @[
                              ...
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localBigImage0.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localGifImage0.gif"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage1.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage0.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localLongImage1.jpg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage7.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage6.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage5.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localGifImage1.gif"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage4.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localLongImage0.jpg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage8.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage3.jpeg"]],
                              [NSURL fileURLWithPath:[self imagePathWithNamed:@"localImage2.jpeg"]],
                              ];
        [self.collectionView reloadData];
    }
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.isImgae) {
        ...
        [self.photoBrowser showPhotoBrowserWithImageUrls:self.urlDataArray placeholder:[self imageNamed:@"placeholder"] index:indexPath.row zoomView:^UIView * _Nonnull(NSInteger index) {
            __typeof(&*weakSelf) strongSelf = weakSelf;
            return [strongSelf zoomView:index];
        }];
    }
