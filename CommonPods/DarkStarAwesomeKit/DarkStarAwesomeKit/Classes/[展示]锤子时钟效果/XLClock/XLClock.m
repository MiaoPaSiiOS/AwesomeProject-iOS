...
- (void)buildUI {
    ...
    clockBack.image = [DSAwesomeKitTool imageNamed:@"xl_clock_back"];
    [self addSubview:clockBack];
    
    //12点 3点
    CGFloat hourH = self.bounds.size.width * 0.07;
    CGFloat hourSpace = self.bounds.size.height * 0.2;
    UIImageView *hour12 = [[UIImageView alloc] initWithImage:[DSAwesomeKitTool imageNamed:@"xl_clock_hour_12"]];
    ...
    UIImageView *hour3 = [[UIImageView alloc] initWithImage:[DSAwesomeKitTool imageNamed:@"xl_clock_hour_3"]];
    ...
    _mid.image = [DSAwesomeKitTool imageNamed:@"xl_clock_mid"];
    
    //时针
    _hourHand = [[XLClockHand alloc] initWithFrame:CGRectMake(0, 0, hourhandHeight, hourhandHeight)];
    _hourHand.center = handCenter;
    _hourHand.handImage = [DSAwesomeKitTool imageNamed:@"xl_clock_hourHand"];
    _hourHand.shadowImage = [DSAwesomeKitTool imageNamed:@"xl_clock_hourHand_shadow"];
    ...
    _minuteHand.handImage = [DSAwesomeKitTool imageNamed:@"xl_clock_minuteHand"];
    _minuteHand.shadowImage = [DSAwesomeKitTool imageNamed:@"xl_clock_minuteHand_shadow"];
    ...
    _secondHand.handImage = [DSAwesomeKitTool imageNamed:@"xl_clock_secondHand"];
    _secondHand.shadowImage = [DSAwesomeKitTool imageNamed:@"xl_clock_secondHand_shadow"];
