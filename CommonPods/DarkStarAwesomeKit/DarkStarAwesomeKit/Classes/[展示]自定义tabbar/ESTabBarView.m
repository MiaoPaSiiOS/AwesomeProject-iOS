...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    self.tabbarHeight = DSDeviceInfo.tabBarContentHeight;
    [self initBgView];
    [self initBtn];
    return self;
}
...
- (void)initBgView{
    ...
    if (DSDeviceInfo.isNotchedScreen) {
        CGFloat HOME_INDICATOR_HEIGHT = DSDeviceInfo.tabBarHeight - DSDeviceInfo.tabBarContentHeight;
...
//                                        @"tabbar_market",
    ...
    CGFloat w = DSDeviceInfo.screenWidth / 5;
    for (int i=0; i<titles.count; i++) {
        ...
        [btn setTitleColor:[DSHelper RGBA:51 green:51 blue:51] forState:UIControlStateNormal];
