...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_default"];
...
- (void)setState:(HWDownloadState)state {
    ...
    switch (state) {
        case HWDownloadStateDefault:
            _imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_default"];
            break;
        ...
        case HWDownloadStateWaiting:
            _imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_waiting"];
            break;
            
        case HWDownloadStatePaused:
            _imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_pause"];
            break;
            
        case HWDownloadStateFinish:
            _imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_finish"];
            break;
            
        case HWDownloadStateError:
            _imgView.image = [DSAwesomeKitTool imageNamed:@"com_download_error"];
            break;
