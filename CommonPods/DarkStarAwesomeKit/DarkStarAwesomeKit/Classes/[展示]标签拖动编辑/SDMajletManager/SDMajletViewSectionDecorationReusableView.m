//
//  SDMajletViewSectionDecorationReusableView.m
//  REWLY
//
...
@implementation SDMajletViewSectionCardDecorationCollectionViewLayoutAttributes
...
@interface SDMajletViewSectionDecorationReusableView()
@property(nonatomic, strong) UIImageView *background;
@end

@implementation SDMajletViewSectionDecorationReusableView
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes {
    ...
    if ([layoutAttributes isKindOfClass:SDMajletViewSectionCardDecorationCollectionViewLayoutAttributes.class]) {
        SDMajletViewSectionCardDecorationCollectionViewLayoutAttributes *attributes = (SDMajletViewSectionCardDecorationCollectionViewLayoutAttributes *)layoutAttributes;
