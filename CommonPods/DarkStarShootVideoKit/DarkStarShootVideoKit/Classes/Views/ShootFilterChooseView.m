...
+ (void)showFilterWithFilterInfo:(MHFilterInfo *)filterInfo beautifyInfo:(MHBeautifyInfo *)beautifyInfo callBack:(ShootFilterChooseCallBack)callBack hidenHandle:(ShootFilterChooseHidenHandle)hidenHadle
{
    ...
    ShootFilterChooseView * view = [[ShootFilterChooseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight) filterInfo:filterInfo beautiFy:beautifyInfo callBack:callBack hidenHandle:hidenHadle];
