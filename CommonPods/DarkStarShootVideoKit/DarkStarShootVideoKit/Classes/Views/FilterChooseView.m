...
-(void)commit_subViews
{
    {
        //顶部 分类
        self.topTypeBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.width, 45)];
        ...
        for (int i = 0; i < 3; i ++) {
            ...
            item.titleEdgeInsets = UIEdgeInsetsMake(self.topTypeBar.frame.size.height/2, 0, 0, 0);
        }
        self.curentTopIndex = 0;
        [self updateTopTypeItemState:0];
        
        self.topAniLine = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 26, 2)];
    ...
    CGFloat itemHeight = self.frame.size.height - 45;
    ...
    self.filterCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 45, self.frame.size.width, itemHeight) collectionViewLayout:layout];
...
-(void)topItemClick:(UIButton *)sender
{
    ...
    [self.filterCollectionView setContentOffset:CGPointMake(sCellNum*self.curentTopIndex*70, 0) animated:NO];
}
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.filterIcon = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 53, 53)];
        self.filterIcon.center = CGPointMake(width/2, 18+53/2);
        self.filterIcon.image = AmShViImage(@"filter_pre_image");
        self.filterIcon.contentMode = UIViewContentModeScaleAspectFit;
        self.filterIcon.clipsToBounds = YES;
        self.filterIcon.layer.cornerRadius = (53)/2;
        ...
        self.filterName = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.filterIcon.frame) + 10, width, (15))];
