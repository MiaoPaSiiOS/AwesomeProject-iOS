...
- (id)init
{
    ...
    UIImage *image3 = AmShViMainBundleImage(@"toasterOverlayMapWarm");
    ...
    UIImage *image4 = AmShViMainBundleImage(@"toasterColorShift");
