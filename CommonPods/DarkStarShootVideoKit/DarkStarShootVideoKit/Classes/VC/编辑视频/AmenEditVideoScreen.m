...
#import "AmenPublishVideoScreen.h"

@interface AmenEditVideoScreen ()
<EditVideoTopBarDelelate,EditVideoBottomBar,ChooseBGMusicDelegate>
...
@implementation AmenEditVideoScreen
...
-(void)editVideoBottomBarHandleSpecialFilter
{
    ...
    //计算预览图层缩放比例
    CGFloat transHeight = DSDeviceInfo.screenHeight - (50) - (145) - SafeAreaInsetsConstantForDeviceWithNotch.bottom;
    CGFloat transformScale = transHeight / DSDeviceInfo.screenHeight;
    //计算缩放后需要平移的量
    CGFloat offY = DSDeviceInfo.screenHeight/2 - transHeight/2 - (50);
...
-(void)editVideoBottomBarHandleChooseCover
{
    ...
    //计算预览图层缩放比例
    CGFloat transHeight = DSDeviceInfo.screenHeight - (50) - (140) - SafeAreaInsetsConstantForDeviceWithNotch.bottom;
    CGFloat transformScale = transHeight / DSDeviceInfo.screenHeight;
    //计算缩放后需要平移的量
    CGFloat offY = DSDeviceInfo.screenHeight/2 - transHeight/2 - (50);
...
-(void)jumpToPostVC
{
    AmenPublishVideoScreen * vc = [[AmenPublishVideoScreen alloc] init];
...
{
    self.topBar = [[EditVideoTopBar alloc] initWithFrame:CGRectMake(0, SafeAreaInsetsConstantForDeviceWithNotch.top, DSDeviceInfo.screenWidth, (60))];
    self.topBar.delegate = self;
    [self.view addSubview:self.topBar];
    [self.topBar updateCrapBGMItemCanUse:self.videoModel.bgmName.length > 0 ? YES : NO];
    
    self.bottomBar = [[EditVideoBottomBar alloc] initWithFrame:CGRectMake(0, DSDeviceInfo.screenHeight - SafeAreaInsetsConstantForDeviceWithNotch.bottom - (75), DSDeviceInfo.screenWidth, (60))];
