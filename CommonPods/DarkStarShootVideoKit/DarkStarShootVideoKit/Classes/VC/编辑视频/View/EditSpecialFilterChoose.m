...
-(void)commit_movieView
{
    ...
    //计算预览图层缩放比例
    CGFloat transHeight = self.height - (50) - (145) - SafeAreaInsetsConstantForDeviceWithNotch.bottom;
    CGFloat transformScale = transHeight / self.height;
    //计算缩放后需要平移的量
    CGFloat offY = self.height/2 - transHeight/2 - (50);
...
-(void)commit_subViews
{
    ...
    cancleItem.frame = CGRectMake(0, 0, (75), (50));
    [cancleItem setTitle:@"取消" forState:0];
    [cancleItem setTitleColor:[UIColor whiteColor] forState:0];
    cancleItem.titleLabel.font = [UIFont systemFontOfSize:16];
    ...
    sureItem.frame = CGRectMake(self.width - (75), 0, (75), (50));
    [sureItem setTitle:@"完成" forState:0];
    [sureItem setTitleColor:[UIColor whiteColor] forState:0];
    sureItem.titleLabel.font = [UIFont systemFontOfSize:16];
    ...
    UIView * contentView = [[UIView alloc] initWithFrame:CGRectMake(0, self.height - ((145) + SafeAreaInsetsConstantForDeviceWithNotch.bottom), self.width, (145) + SafeAreaInsetsConstantForDeviceWithNotch.bottom)];
    ...
    lab.frame = CGRectMake((15), 0, 120, (45));
    lab.text = @"滤镜特效";
    ...
    CGFloat itemHeight = contentView.frame.size.height - (45);
    ...
    self.filterCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, (45), contentView.frame.size.width, itemHeight) collectionViewLayout:layout];
