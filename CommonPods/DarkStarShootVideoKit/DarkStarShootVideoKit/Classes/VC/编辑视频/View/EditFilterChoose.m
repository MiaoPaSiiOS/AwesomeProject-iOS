...
-(void)commit_subViews
{
    ...
    UIView * contentView = [[UIView alloc] initWithFrame:CGRectMake(0, self.height - ((155) + SafeAreaInsetsConstantForDeviceWithNotch.bottom), self.width, (155) + SafeAreaInsetsConstantForDeviceWithNotch.bottom)];
    ...
    self.filterListview = [[FilterChooseView alloc] initWithFrame:CGRectMake(0, 0, self.width, (155))];
