...
-(void)commit_movieView
{
    ...
    //计算预览图层缩放比例
    CGFloat transHeight = self.height - (50) - (140) - SafeAreaInsetsConstantForDeviceWithNotch.bottom;
...
-(void)commit_subViews
{
    ...
    //底部整体容器
    UIView * listContent = [[UIView alloc] initWithFrame:CGRectMake(0, self.height - ((140) + SafeAreaInsetsConstantForDeviceWithNotch.bottom), self.width, (140) + SafeAreaInsetsConstantForDeviceWithNotch.bottom)];
    ...
    lab.frame = CGRectMake((15), 0, 100, (50));
    lab.text = @"已选封面";
    [listContent addSubview:lab];
    
    //封面所在的容器
    self.coverContent = [[UIView alloc] initWithFrame:CGRectMake((15), (50), self.width - (30), (65))];
