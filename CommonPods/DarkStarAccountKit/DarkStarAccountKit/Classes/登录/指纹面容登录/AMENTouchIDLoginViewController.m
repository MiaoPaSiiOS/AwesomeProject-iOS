//
//  AMENTouchIDLoginViewController.m
//  AFNetworking
//
...
@interface AMENTouchIDLoginViewController ()
// 判断设备是FaceID设备而不是指纹
@property (nonatomic, assign) BOOL isFaceIDDevice;
@end

@implementation AMENTouchIDLoginViewController
...
- (void)initTouchIDLoginView {
    ...
    nameLb.center = CGPointMake(kScreenWidth / 2, userHead.centerY + userHead.height / 2 + 15 + nameLb.height / 2);
    ...
    [self creatButton:touchBtn frame:CGRectMake((kScreenWidth - 75) / 2, nameLb.bottom + 70, 75, 86) title:nil font:nil image:[DSAccountTool imageNamed:@"touchId"]  tag:buttonTagTouchID changeColor:NO];

    // 提示话术按钮
    UIButton *tipButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [self creatButton:tipButton frame:CGRectMake(0, touchBtn.bottom + 10, kScreenWidth, 20) title:@"点击使用指纹登录" font:[UIFont fontWithName:@"PingFangSC-Regular" size:15.0f] image:nil tag:buttonTagTouchID changeColor:NO];

    // 初始化“切换登录方式”按钮
    UIButton *checkButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [self creatButton:checkButton frame:CGRectMake(0, kScreenHeight - 90, kScreenWidth, 30) title:@"更多登录方式" font:[UIFont fontWithName:@"PingFangSC-Regular" size:15.0f] image:nil tag:buttonTagTouchIDCheck changeColor:NO];
}
...
- (void)initFaceIDLoginView {
    ...
    // 中间指纹按钮
    UIButton *touchBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [self creatButton:touchBtn frame:CGRectMake((kScreenWidth - 75) / 2, nameLb.bottom + 70, 75, 86) title:nil font:nil image:[DSAccountTool imageNamed:@"touchId.png"]  tag:buttonTagTouchID changeColor:NO];
