//
//  NrBaseCoreKitDefines.h
//  Pods
//
//  Created by zhuyuhui on 2022/8/3.
//

#ifndef NrBaseCoreKitDefines_h
#define NrBaseCoreKitDefines_h
...
#ifndef kStringColor
#define kStringColor(colorString) [UIColor nr_colorWithColorString:colorString]
#endif
 ...
 */
#ifndef NrFrameAll
#define NrFrameAll(x,y,w,h) CGRectMake((x), (y), (w), (h))
#endif
 ...
 */
#ifndef NrFrame
#define NrFrame(w,h) NrFrameAll(0,0,w,h)
#endif

/**
 *    @brief    完整填充frame的矩形框.
 */
#ifndef NrFrameAllInset
#define NrFrameAllInset(frame) NrFrame(frame.size.width,frame.size.height)
#endif
/**
 *    @brief    以inset填充矩形框.
 */
#ifndef NrFrameInset
#define NrFrameInset(frame,inset) CGRectMake(inset.left, inset.top, frame.size.width - inset.left - inset.right, frame.size.height - inset.top - inset.bottom)
#endif


/** 按比例适配的宽度 */
#define NrAutoScale(value) (kAdaptScreenScale(APP_WidthScale * (value)))
...
////////////////////////快速创建测试按钮
#define NR_BUTTON_WITH_ACTION(_title, _sel)  \
{   \
...
#define NR_CREATE_UI(_addButton, _superView)   \
{   \
