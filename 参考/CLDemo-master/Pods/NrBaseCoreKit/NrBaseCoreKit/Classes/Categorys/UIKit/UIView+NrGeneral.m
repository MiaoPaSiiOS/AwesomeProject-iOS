...
#import "UIView+NrGeneral.h"

@implementation UIView (NrGeneral)
...
{
    [self nr_addRectCornerWithViewBounds:self.bounds corner:corner radius:radius];
}

- (void)nr_addAllCornerWith:(CGFloat)radius
{
    [self nr_addRectCornerWith:UIRectCornerAllCorners radius:radius];
}
- (void)nr_addAllCornerWithViewBounds:(CGRect)rect radius:(CGFloat)radius
{
    [self nr_addRectCornerWithViewBounds:rect corner:UIRectCornerAllCorners radius:radius];
}
...
#pragma mark - 添加渐变色
- (void)nr_addGraduallyLayerWithStartColor:(UIColor *)startColor withendColor:(UIColor *)endColor {
    [self nr_addGraduallyLayerWithStartColor:startColor withendColor:endColor];
}

- (void)nr_addGraduallyLayer:(CGRect)frame withStartColor:(UIColor *)startColor withendColor:(UIColor *)endColor {
