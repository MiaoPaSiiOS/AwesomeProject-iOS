...
- (void)updateTime:(NSInteger)time nextTime:(NSInteger)nextTime animated:(BOOL)animated{
    ...
    if (animated) {
        ...
        _foldLabel.layer.transform = CATransform3DIdentity;
        _foldLabel.text = _nextLabel.text;
        _nextLabel.hidden = false;
    }
}
