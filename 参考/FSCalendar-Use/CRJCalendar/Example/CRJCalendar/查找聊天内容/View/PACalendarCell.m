...
- (void)configureAppearance
{
    ...
    _subtitleLabel.textColor = [UIColor colorWithHexString:@"#5E5E5E"];
    /// title
    ...
    if (self.model.selected) {
        ...
        if (self.model.hasEvent) {
            ...
            _titleLabel.textColor = [UIColor colorWithHexString:@"#979797"];
        }
    }
    ...
    // 设置选中
    UIColor *borderColor = [UIColor colorWithHexString:@"#00C771"];
    UIColor *fillColor = [UIColor colorWithHexString:@"#00C771"];
