...
#ifndef UIImageFGAddCLAMP // return the clamped value
#define UIImageFGAddCLAMP(_a_, _b_)  do { __typeof__(_a_) _tmp_ = (_a_); (_a_) = (_b_); (_b_) = _tmp_; } while (0)
#endif
...
- (UIImage *)imageByBlurRadius:(CGFloat)blurRadius
    ...
    if (hasBlur) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            UIImageFGAddCLAMP(input, output);
        }
        free(temp);
    }
