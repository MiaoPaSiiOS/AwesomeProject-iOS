...
+ (UIImage *)imageNamed:(NSString *)name {
    NSBundle *bundle = Nr_BUNDLE(@"NrHWDownloadManager", @"NrDataStoreFramework");
    UIImage *image = [UIImage imageWithContentsOfFile:[NSString stringWithFormat:@"%@/Assets/Images/%@",bundle.bundlePath,name]];
    return image;
}
