...
@implementation NrGridViewLayout
#pragma mark - 初始化属性
- (instancetype)init {
    self = [super init];
    if (self) {
...
- (void)prepareLayout {
    ...
    for (NSInteger section = 0; section < sections; section++) {
        ...
        //head
        CGSize sectionHeadSize = [self.delegate NrGridViewLayout:self sizeForSupplementaryElementOfKind:UICollectionElementKindSectionHeader section:section];
        ...
        for (NSInteger item = 0; item < rows; item++) {
            ...
            CGFloat tagWidth = [self.delegate NrGridViewLayout:self widthForItemAt:indexPath];
        ...
        //footer
        CGSize sectionFooterSize = [self.delegate NrGridViewLayout:self sizeForSupplementaryElementOfKind:UICollectionElementKindSectionFooter section:section];
