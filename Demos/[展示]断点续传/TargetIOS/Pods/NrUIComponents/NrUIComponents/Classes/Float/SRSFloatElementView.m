...
- (void)defaultTypeInit {
    ...
    UIImage *buttonImage = NrPOD_IMAGE(@"circle_close", Nr_BUNDLE(@"NrFloatAssets", @"NrUIComponents"));
...
- (void)customTypeInit {
    UIImage *buttonImage = NrPOD_IMAGE(@"cross_close", Nr_BUNDLE(@"NrFloatAssets", @"NrUIComponents"));
    [self.dismissButton setBackgroundImage:buttonImage forState:UIControlStateNormal];
