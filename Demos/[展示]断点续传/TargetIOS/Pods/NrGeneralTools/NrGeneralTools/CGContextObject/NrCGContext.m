...
#import "NrCGContext.h"

@interface NrCGContext ()

@property (nonatomic)         CGContextRef           context;
@property (nonatomic, strong) NrCGContextConfig *currentConfig;
@property (nonatomic, strong) NSMutableDictionary    <NSString *, NrCGContextConfig *> *configs;

@end

@implementation NrCGContext
...
- (void)useCGContextConfig:(NrCGContextConfig *)contextConfig storeAsCurrentConfig:(BOOL)asCurrentConfig {
...
- (void)contextConfig:(NrCGContextConfig *)config
      drawStrokeBlock:(NrCGContextDrawBlock_t)block {
    ...
    if (block) {
        ...
        __weak NrCGContext *weakSelf = self;
...
- (void)contextConfig:(NrCGContextConfig *)config
        drawFillBlock:(NrCGContextDrawBlock_t)block {
...
- (void)contextConfig:(NrCGContextConfig *)config
          drawingMode:(CGPathDrawingMode)drawingMode
            drawBlock:(NrCGContextDrawBlock_t)block {
