//
//  NrIrregularElementsCreator.m
//  TMall
//
//  Created by zhuyuhui on 2022/8/7.
//

#import "NrIrregularElementsCreator.h"

@interface NrIrregularElementsCreator ()
...
@implementation NrIrregularElementsCreator
...
+ (instancetype)irregularElementsCreatorWithItemIsRightToLeft:(BOOL)isRightToLeft
    ...
    NrIrregularElementsCreator *creator = [NrIrregularElementsCreator new];
...
+ (void)irregularElementsCreatorWithItemIsRightToLeft:(BOOL)isRightToLeft
    ...
    NrIrregularElementsCreator *creator = [NrIrregularElementsCreator irregularElementsCreatorWithItemIsRightToLeft:isRightToLeft
