//
//  NrJailBreakChecker.m
//  CRJGeneralTools
//
//

#import "NrJailBreakChecker.h"

@implementation NrJailBreakChecker
/*
 1.通过越狱后增加的越狱文件判断
...
+ (BOOL)isJailBroken {
    if ([NrJailBreakChecker isJailBreak1]){
        return YES;
    }
    if ([NrJailBreakChecker isJailBreak2]){
        return YES;
    }
    if ([NrJailBreakChecker isJailBreak3]){
        return YES;
    }
    return NO;
}
