...
@protocol NrBTTimerHelpDelegate <NSObject>

@optional

-(void)BTTimeChanged:(NrBTTimerHelp*)timer;

@end

typedef void(^BTTimerChangeBlock)(void);

@interface NrBTTimerHelp : NSObject
...
@property(nonatomic,weak,nullable)id<NrBTTimerHelpDelegate> delegate;
