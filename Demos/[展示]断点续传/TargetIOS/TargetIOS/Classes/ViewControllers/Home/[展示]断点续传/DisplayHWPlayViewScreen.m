...
{
    // 进度条
    UISlider *slider = [[UISlider alloc] initWithFrame:CGRectMake(50, 400, kScreenWidth - 100, 50)];
    [slider addTarget:self action:@selector(sliderValueChanged:) forControlEvents:UIControlEventValueChanged];
    [self.nrView addSubview:slider];
    ...
    playerLayer.frame = CGRectMake(0, 0, kScreenWidth, 400);
    [self.nrView.layer addSublayer:playerLayer];
