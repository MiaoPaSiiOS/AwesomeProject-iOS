...
- (void)creatBaseControl {
    ...
    [navRightBtn setImage:[UIImage imageNamed:@"nav_deleteBtn"] forState:UIControlStateNormal];
    [navRightBtn setImage:[UIImage imageNamed:@"nav_deleteBtn"] forState:UIControlStateHighlighted];
    [navRightBtn setImage:[UIImage imageNamed:@"nav_cancelBtn"] forState:UIControlStateSelected];
    [navRightBtn addTarget:self action:@selector(navBtnOnClick:) forControlEvents:UIControlEventTouchUpInside];
    self.appBar.rightBarButtonItem = [[NrBarButtonItem alloc] initWithCustomView:navRightBtn];
...
- (void)navBtnOnClick:(UIButton *)btn {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        self.tabbarView.top = self.isNavEditing ?  kScreenHeight - kTabBarHeight : kScreenHeight;
    }];
}
