...
- (void)setupDefaultSubViews {
    ...
    [self.checkBtn setImage:[UIImage imageNamed:@"spUnseleted"] forState:UIControlStateNormal];
    [self.checkBtn setImage:[UIImage imageNamed:@"spSeleted"] forState:UIControlStateSelected];
