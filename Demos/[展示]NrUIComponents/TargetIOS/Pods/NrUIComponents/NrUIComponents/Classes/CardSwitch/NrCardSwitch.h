...
@protocol NrCardSwitchDataSource <NSObject>
@required
...
@protocol NrCardSwitchDelegate <NSObject>
...
@interface NrCardSwitch : UIView

@property(nonatomic, strong, readonly) UICollectionView *collectionView;
/**
 代理
 */
@property(nonatomic, weak) id<NrCardSwitchDelegate>delegate;
@property(nonatomic, weak) id<NrCardSwitchDataSource>dataSource;
