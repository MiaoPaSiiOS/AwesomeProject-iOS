...
#import "NrAlertController.h"

CGFloat kButtonHeight = 44.f;
NSInteger kButtonTag = 74637;
NSInteger SftwAlertContrllerTag = 837458;
#define kAlertControllerWidth ([UIScreen mainScreen].bounds.size.width-100)

@interface NrAlertButtonsView : UIView
...
@implementation NrAlertButtonsView
...
- (void)initSubviews {
    ...
    for (NSInteger i = 0; i < self.buttonsArray.count; i++) {
        ...
        button.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:15.f];
...
@implementation NrAlertController
...
- (void)initSubviews {
    ...
    if (self.titleStr.length) {
        ...
        self.titleLbl.font = [UIFont fontWithName:@"PingFangSC-Medium" size:15.f];
    ...
    self.messageLbl.font = [UIFont fontWithName:@"PingFangSC-Regular" size:15.f];
    self.messageLbl.textColor = kHexColor(0x333333);
    ...
    NrAlertButtonsView *buttonsView = [[NrAlertButtonsView alloc] initWithButtonsArray:self.actionNameArray];
...
- (void)initSubviewsWithAttrString:(NSAttributedString *)attrMessage message:(NSString *)message {
    ...
    self.messageLbl = [[UILabel alloc] init];
    self.messageLbl.textColor = kHexColor(0x222222);
...
+ (void)alertWithTitle:(NSString *)title message:(NSString *)message actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithTitle:title message:message acionNames:actionNames autoDismiss:YES clickAcion:clickAction];
...
+ (instancetype)alertCustomDismissWithTitle:(NSString *)title message:(NSString *)message actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithTitle:title message:message acionNames:actionNames autoDismiss:NO clickAcion:clickAction];
...
+ (void)alertWithIconName:(NSString *)iconName attrMessage:(NSAttributedString *)attrMessage actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithIconName:iconName attrMessage:attrMessage message:nil acionNames:actionNames autoDismiss:YES clickAcion:clickAction];
    [self addAlertController:alertController];
...
+ (instancetype)alertCustomDismissWithIconName:(NSString *)iconName attrMessage:(NSAttributedString *)attrMessage actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithIconName:iconName attrMessage:attrMessage message:nil acionNames:actionNames autoDismiss:NO clickAcion:clickAction];
    return [self addCustomDismissAlertController:alertController];
}
...
+ (void)alertWithIconName:(NSString *)iconName message:(NSString *)message actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithIconName:iconName attrMessage:nil message:message acionNames:actionNames autoDismiss:YES clickAcion:clickAction];
    [self addAlertController:alertController];
...
+ (instancetype)alertCustomDismissWithIconName:(NSString *)iconName message:(NSString *)message actionNames:(NSArray<NSString *> *)actionNames clickAcion:(ClickActionBlock)clickAction {
    NrAlertController *alertController = [[NrAlertController alloc] initWithIconName:iconName attrMessage:nil message:message acionNames:actionNames autoDismiss:NO clickAcion:clickAction];
    return [self addCustomDismissAlertController:alertController];
}



+ (void)addAlertController:(NrAlertController *)alertController {
    NrAlertController *alertView = [[UIApplication sharedApplication].keyWindow viewWithTag:SftwAlertContrllerTag];
...
+ (NrAlertController *)addCustomDismissAlertController:(NrAlertController *)alertController {
    NrAlertController *alertView = [[UIApplication sharedApplication].keyWindow viewWithTag:SftwAlertContrllerTag];
    if (!alertView && ![alertView isDescendantOfView:[UIApplication sharedApplication].keyWindow]) {
        [[UIApplication sharedApplication].keyWindow addSubview:alertController];
