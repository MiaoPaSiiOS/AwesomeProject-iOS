...
typedef NS_ENUM(NSUInteger, NrGestureRecognizerState) {
    NrGestureRecognizerStateBegan, ///< gesture start
    NrGestureRecognizerStateMoved, ///< gesture moved
    NrGestureRecognizerStateEnded, ///< gesture end
    NrGestureRecognizerStateCancelled, ///< gesture cancel
};

/**
 A simple UIGestureRecognizer subclass for receive touch events.
 */
@interface NrGestureRecognizer : UIGestureRecognizer
...
@property (nullable, nonatomic, copy) void (^action)(NrGestureRecognizer *gesture, NrGestureRecognizerState state);
