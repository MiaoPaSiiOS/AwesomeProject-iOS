...
@interface NrBaseDialogView : UIView
#pragma mark - 视图容器
...
#pragma mark - 回调
@property(nonatomic, copy) void (^dialogWillShow)(NrBaseDialogView *dialog);
@property(nonatomic, copy) void (^dialogDidShow)(NrBaseDialogView *dialog);
@property(nonatomic, copy) void (^dialogWillHide)(NrBaseDialogView *dialog);
@property(nonatomic, copy) void (^dialogDidHide)(NrBaseDialogView *dialog);
