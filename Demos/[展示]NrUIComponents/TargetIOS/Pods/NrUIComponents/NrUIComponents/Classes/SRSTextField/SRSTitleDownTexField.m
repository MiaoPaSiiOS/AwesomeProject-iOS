...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, kScreenWidth, (281/2.));
...
- (UILabel *)flagLabel {
    if (!_flagLabel) {
        ...
        _flagLabel.textColor = kHexColor(0x222222);
    }
    return _flagLabel;
}
...
- (UIButton *)bottomBtn {
    if (!_bottomBtn) {
        ...
        [_bottomBtn setTitleColor:kHexColor(0x4586FF) forState:UIControlStateNormal];
