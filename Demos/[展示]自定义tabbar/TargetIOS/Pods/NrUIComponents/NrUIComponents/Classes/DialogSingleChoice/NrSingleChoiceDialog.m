...
@interface NrSingleChoiceDialog ()<UIPickerViewDelegate, UIPickerViewDataSource>

@end

@implementation NrSingleChoiceDialog
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    NrSingleChoiceDialogReusingView *customView = (NrSingleChoiceDialogReusingView *)view;
    if (customView == nil) {
        customView = [[NrSingleChoiceDialogReusingView alloc] initWithFrame:CGRectMake(0, 0,kScreenWidth - 20,44.f)];
    }
    
    customView.row       = row;
    customView.component = component;
    customView.data      = [self.showDatas nr_objectWithIndex:row];
