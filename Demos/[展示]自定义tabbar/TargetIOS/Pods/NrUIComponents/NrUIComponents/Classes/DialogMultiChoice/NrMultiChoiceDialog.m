...
@interface NrMultiChoiceDialog ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation NrMultiChoiceDialog
...
#pragma mark - 其他
    ...
    if (!self.cellClass) {
        self.cellClass = NrMultiChoiceDialogCell.class;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NrMultiChoiceDialogCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
