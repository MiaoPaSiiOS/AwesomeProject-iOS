...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        UIImage *image1 = [self clipImageWithImage:[UIImage imageNamed:@"one"]
                                              rect:CGRectMake(width * 0.25, -height * 0.25, width, height) startAngle:-90 endAngle:(30)];
        UIImage *image2 = [self clipImageWithImage:[UIImage imageNamed:@"two"]
                                              rect:CGRectMake(0, height * 0.25, width, height) startAngle:30 endAngle:(150)];
        UIImage *image3 = [self clipImageWithImage:[UIImage imageNamed:@"three"]
                                              rect:CGRectMake(-width * 0.25, -height * 0.25, width, height) startAngle:150 endAngle:(270)];
