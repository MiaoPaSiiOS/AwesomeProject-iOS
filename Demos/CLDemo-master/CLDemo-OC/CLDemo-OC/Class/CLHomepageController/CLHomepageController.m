...
- (NSMutableArray *) arrayDS {
    if (_arrayDS == nil) {
        ...
        [_arrayDS addObject: [[CLHomepageModel alloc] initName:@"仿系统指南针" controllerClass:[CLSystemCompassViewController class]]];
        [_arrayDS addObject: [[CLHomepageModel alloc] initName:@"锤子时钟效果" controllerClass:[CLXLClockViewController class]]];
        [_arrayDS addObject: [[CLHomepageModel alloc] initName:@"时钟翻页效果" controllerClass:[CLFoldClockViewController class]]];
        [_arrayDS addObject: [[CLHomepageModel alloc] initName:@"UICollectionView装饰视图" controllerClass:[CLDecorationViewController class]]];
