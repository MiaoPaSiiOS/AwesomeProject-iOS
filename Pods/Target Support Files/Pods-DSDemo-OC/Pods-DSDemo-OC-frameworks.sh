...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DarkStarEnjoyCameraKit/DarkStarEnjoyCameraKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DarkStarShootVideoKit/DarkStarShootVideoKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TZImagePickerController-framework/TZImagePickerController.framework"
